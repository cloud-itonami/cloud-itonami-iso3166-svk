(ns marketentry.marketentryllm
  ...
  the SVK public-sector market-entry compliance actor.
  ...
  cited), never a committed record or a real EPVO submission. Every
...
(defn- propose-submit
  ...
  :actuation/submit-filing` -- real-world EPVO submission."
  [db {:keys [subject]}]
  (let [e (store/engagement db subject)]
