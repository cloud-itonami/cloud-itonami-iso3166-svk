(ns marketentry.registry
  ...
  call to any real procurement portal (EPVO / isepvo.sk). It builds
  the RECORD an operator would keep, not the act of submitting a
...
(defn register-draft
  ...
  market-entry operator's own act of preparing an EPVO registration
...
(defn register-submit
  ...
  market-entry operator's own act of actually submitting an EPVO
